      ...
      <main className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Free woodworking tool to calculate board feet and estimate material costs
          </p>
        </div>
        ...
        <div className="mt-12 rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-900/5">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-600">
              A board foot is a unit of measurement for lumber volume. One board foot equals the volume of a board that is 1 inch thick, 12 inches wide, and 12 inches long (1&quot; × 12&quot; × 12&quot; = 144 cubic inches).
            </p>
            ...
            <ul className="mt-4 space-y-2 text-gray-600">
              <li>• All measurements must be in inches</li>
              <li>• Length is measured along the grain</li>
              <li>• Width is measured across the grain</li>
              <li>• Thickness is the actual thickness of the board</li>
            </ul>
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-2">Example Calculation</h3>
            <p className="text-gray-600">
              A board that is 8 feet long (96&quot;), 6 inches wide, and 1 inch thick:
              <br />
        ...
        <div className="mt-12 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 p-8 text-center shadow-xl">
          ...
          <p className="text-amber-50 mb-6 max-w-2xl mx-auto">
            CraftQuote helps you turn board feet calculations into professional quotes. Track materials, labor, and profit margins all in one place.
          </p>
          <Link
            href="/signup"
